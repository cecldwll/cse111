...
def populate_main_window(frm_main):
    ...
    lbl_rate_units = Label(frm_main, text="inches")
    ...
    lbl_height_units.grid(row=0, column=2, padx=0, pady=3)
    ...
    lbl_rate_units.grid(row=2, column=2, padx=0, pady=3)
    ...
    def calculate(event):
        ...
        try:
            ...
            lbl_result.config(text=f"{area_calc:.0f}")

        except ValueError:
            # When the user deletes all the digits in the
